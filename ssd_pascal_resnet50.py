...
model_name = "ResNet_LOGO_{}".format(job_name)

# Directory which stores the model .prototxt file.
save_dir = "models/ResNet/LOGO/{}".format(job_name)
# Directory which stores the snapshot of models.
snapshot_dir = "models/ResNet/LOGO/{}".format(job_name)
# Directory which stores the job script and log file.
job_dir = "jobs/ResNet/LOGO/{}".format(job_name)
...
# pool6 ==> 1 x 1
mbox_source_layers = ['res2c_relu', 'res3d_relu',
                      'res4f_relu', 'res5c_relu',
                      'res5c_relu/conv1_2', 'res5c_relu/conv2_2',
                      'res5c_relu/conv3_2', 'pool6']
# in percent %
min_ratio = 20
max_ratio = 95
